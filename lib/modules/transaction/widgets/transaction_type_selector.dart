...
class TransactionTypeSelector extends GetView<TransactionController> {
  ...
  Widget build(BuildContext context) {
    return Obx(()=>SegmentedButton(segments: [
        ButtonSegment(value: "expense", label: Text("gider"),icon: Icon(Icons.remove_circle_outlined)),
        ButtonSegment(value: "income", label: Text("gelir"),icon: Icon(Icons.add_circle_outlined),)
